...
export default function ShootTab({
  ...
  nails, selectedNail, setSelectedNail, onDescribeNail, onSaveNail, onDeleteNail,
}) {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[3fr_2fr] gap-8">
      ...
      <div className="space-y-6 xl:sticky xl:top-6 xl:self-start">
        ...
        <NailPicker nails={nails} selected={selectedNail} onSelect={setSelectedNail} onClear={() => setSelectedNail(null)} onDescribe={onDescribeNail} onSave={onSaveNail} onDelete={onDeleteNail} />
      </div>
    </div>
  );
}
