...
import { Check, Ban, ScanSearch, Sparkles, Download, ChevronDown, Trash2, Eraser } from 'lucide-react'
import { runView } from '@/lib/throughline'
...
export default function Review({ runs, onOpen, onMark, onDelete, stats, onExportGold, onPurgeRejected, onCleanupImages }) {
    ...
    <main className="mx-auto max-w-[1360px] px-5 py-6">
      <div className="mb-4 flex items-end justify-between">
        ...
        <div className="flex items-center gap-3">
          {onCleanupImages && (
            <button onClick={onCleanupImages} title="reclaim disk from orphaned images and spent outfit/body/calibration intermediates"
              className="eve-button border border-[#353541] text-[#a9a9b6]"><Eraser className="h-3.5 w-3.5" /> clean up images</button>
          )}
