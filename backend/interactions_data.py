...
INTERACTIONS: dict[str, dict[str, dict]] = {
    ...
    "Exotic": {
        "mirrored-arches": {"text": "A and B stand side by side arching their spines in opposite directions, their bodies forming a single symmetrical shape.",
            "min_cast": 2},
        "entwined-silhouette": {"text": "The two stand pressed close in profile against the light, their outlines reading as one continuous form.",
            "min_cast": 2},
        "one-high-one-low": {"text": "A stands tall with arms raised while B is crouched low at her feet, the two occupying opposite halves of the frame.",
            "min_cast": 2},
        "shared-fabric-drape": {"text": "One length of sheer fabric is draped across both of them, each holding an end and leaning away from the other.",
            "min_cast": 2},
        "back-arch-support": {"text": "B leans backward into A's arms in a deep arch, A taking her weight from behind.",
            "min_cast": 2},
        "counterbalance-lean": {"text": "A and B lean away from one another with hands clasped between them, held up by the opposing weight.",
            "min_cast": 2},
        "floor-spiral-pair": {"text": "Both lie on the floor with heads close together and bodies spiralling outward in opposite directions.",
            "min_cast": 2},
        "reaching-toward-each-other": {"text": "A and B stretch toward each other from opposite sides of the frame, fingertips not quite meeting.",
            "min_cast": 2},
        "one-lifting-hair": {"text": "A stands behind B lifting her hair clear of her neck with both hands, B's chin raised.",
            "min_cast": 2},
        "stacked-profiles": {"text": "The two stand in exact profile one behind the other, only the front figure's face fully visible.",
            "min_cast": 2},
        "twin-crouch-mirror": {"text": "Both crouch low facing each other with knees wide and hands planted, mirroring the same shape.",
            "min_cast": 2},
        "arms-arch-overhead": {"text": "A and B face each other and raise their arms overhead until their fingertips meet in an arch.",
            "min_cast": 2},
        "seated-back-to-back-arch": {"text": "Seated back to back on the floor, both arching away from one another with heads tipped back.",
            "min_cast": 2},
        "one-draped-over": {"text": "B is draped backward over A's supporting arm, her free arm trailing toward the floor.",
            "min_cast": 2},
        "diagonal-lean-pair": {"text": "A and B lean in the same diagonal direction at the same angle, one behind the other.",
            "min_cast": 2},
        "hands-on-shoulders-line": {"text": "A stands behind B with both hands on her shoulders, both faces turned the same way toward the light.",
            "min_cast": 2},
        "kneeling-facing-arch": {"text": "Both kneel facing one another and arch backward simultaneously, hands reaching for their own heels.",
            "min_cast": 2},
        "wrapped-fabric-turn": {"text": "The two turn slowly inside a shared wrap of fabric, wound together at the waist.",
            "min_cast": 2},
        "lying-head-to-head": {"text": "Lying flat with the crowns of their heads touching and bodies extending in opposite directions.",
            "min_cast": 2},
        "one-standing-one-reclined": {"text": "A stands over B, who is reclined at her feet with one arm reaching up along A's leg.",
            "min_cast": 2},
        "shadow-and-light": {"text": "A stands fully in the light and B just behind her in shadow, their poses identical.",
            "min_cast": 2},
        "twisted-embrace-away": {"text": "The two hold each other at the waist while twisting their upper bodies in opposite directions.",
            "min_cast": 2},
        "linked-overhead-clasp": {"text": "Standing shoulder to shoulder with inside arms raised and hands clasped high above them.",
            "min_cast": 2},
        "one-lifted-off-floor": {"text": "A lifts B slightly clear of the floor from behind, B's legs relaxed and pointed.",
            "min_cast": 2},
        "seated-legs-interlaced": {"text": "Seated facing each other on the floor with legs interlaced and both leaning back on their hands.",
            "min_cast": 2},
        "profile-and-full-face": {"text": "A is in exact profile and B is square to the camera directly behind her, the two heads overlapping.",
            "min_cast": 2},
        "mirrored-hip-tilt": {"text": "Both stand with hips thrown toward each other and outside arms sweeping overhead.",
            "min_cast": 2},
        "crouch-and-tower": {"text": "B crouches tight to the floor while A stands directly over her with legs apart.",
            "min_cast": 2},
        "hair-fall-shared": {"text": "The two lean their heads together and let their hair fall forward until it mixes into one mass.",
            "min_cast": 2},
        "arch-over-lap": {"text": "B lies back across A's lap in a deep arch with her head dropped past A's knee.",
            "min_cast": 2},
        "opposing-spirals": {"text": "A and B stand close and spiral their torsos in opposite directions, hips still touching.",
            "min_cast": 2},
        "one-behind-arms-through": {"text": "A stands behind B and threads both arms through under B's, the four arms reading as one set.",
            "min_cast": 2},
        "floor-tangle-legs": {"text": "Both lie on the floor with legs overlapping and torsos angled away from each other.",
            "min_cast": 2},
        "held-wrist-pull": {"text": "A holds B's wrist and leans back, B leaning the opposite way against the pull.",
            "min_cast": 2},
        "sculpted-column": {"text": "The two press together back to front and stand perfectly still, forming a single vertical column.",
            "min_cast": 2},
        "one-arched-one-straight": {"text": "A stands rigidly straight while B arches deeply beside her, the contrast doing the work.",
            "min_cast": 2},
        "seated-lean-shoulders": {"text": "Seated side by side leaning their shoulders hard into one another, heads tipped apart.",
            "min_cast": 2},
        "reaching-past-each-other": {"text": "A and B reach past one another in opposite directions, torsos crossing at the waist.",
            "min_cast": 2},
        "kneel-and-stand-line": {"text": "A kneels and B stands directly behind, both arms extended along the same diagonal.",
            "min_cast": 2},
        "twin-floor-arch": {"text": "Both on their backs side by side, hips lifted into simultaneous bridges.",
            "min_cast": 2},
        "veil-between": {"text": "One sheer panel of fabric hangs between them, both faces pressed close to either side of it.",
            "min_cast": 2},
        "one-turning-one-still": {"text": "A turns sharply with fabric flying while B stands motionless beside her.",
            "min_cast": 2},
        "shoulder-blade-press": {"text": "Standing back to back pressed at the shoulder blades, both leaning their heads back until they touch.",
            "min_cast": 2},
        "low-and-lower": {"text": "Both crouch, one slightly lower than the other, staggered in depth toward the camera.",
            "min_cast": 2},
        "arms-crossed-between": {"text": "Facing one another with arms crossed and each holding the other's opposite hand.",
            "min_cast": 2},
        "spiral-around-each-other": {"text": "The two circle one another mid-turn, bodies angled inward, faces toward the camera.",
            "min_cast": 2},
        "one-supine-one-kneeling": {"text": "B lies supine while A kneels above her head, both arms extended down toward B's shoulders.",
            "min_cast": 2},
        "matched-side-bends": {"text": "Standing a pace apart, both bending sideways toward each other with inside arms overhead.",
            "min_cast": 2},
        "hands-on-each-waist": {"text": "Facing one another with each resting both hands on the other's waist, leaning back from the hips.",
            "min_cast": 2},
        "silhouette-overlap": {"text": "Standing overlapped against a bright background so the two silhouettes read as one shape.",
            "min_cast": 2},
    },
    "Lustful": {
        "foreheads-touching": {"text": "A and B stand very close with their foreheads resting together and eyes closed.",
            "min_cast": 2},
        "hand-on-waist-behind": {"text": "A stands close behind B with one hand resting low on her waist, both looking toward the camera.",
            "min_cast": 2},
        "whisper-at-ear": {"text": "A leans in to speak close at B's ear, B's eyes drifting toward the lens.",
            "min_cast": 2},
        "back-to-chest-lean": {"text": "B leans back against A's chest with her head tipped onto A's shoulder, both relaxed.",
            "min_cast": 2},
        "gaze-locked-close": {"text": "The two stand face to face a hand's width apart, holding each other's eyes and ignoring the camera.",
            "min_cast": 2},
        "hand-in-hair": {"text": "A has one hand buried in B's hair at the back of her head, B's chin lifted.",
            "min_cast": 2},
        "shoulder-strap-adjust": {"text": "A reaches across to lift a fallen strap back onto B's shoulder, both watching the movement.",
            "min_cast": 2},
        "seated-lap-lean": {"text": "B sits across A's lap leaning back into her, one arm draped around A's neck.",
            "min_cast": 2},
        "cheek-against-cheek": {"text": "The two press cheek to cheek facing the same direction, eyes on the lens.",
            "min_cast": 2},
        "hand-at-jaw-turn": {"text": "A turns B's face gently toward her with a hand at the jaw, both in profile to the camera.",
            "min_cast": 2},
        "lying-face-to-face": {"text": "Both lie on their sides facing one another, knees touching, one hand resting on the other's arm.",
            "min_cast": 2},
        "arm-across-collarbone": {"text": "A stands behind B with one arm laid across B's collarbones, drawing her back.",
            "min_cast": 2},
        "kneeling-close-pair": {"text": "Both kneel upright facing each other, thighs touching, hands resting on each other's hips.",
            "min_cast": 2},
        "over-shoulder-both": {"text": "The two stand back to back and each turns her head to look over the same shoulder at the lens.",
            "min_cast": 2},
        "hand-on-stomach-behind": {"text": "A stands behind B with a flat hand resting on her stomach, B leaning back into it.",
            "min_cast": 2},
        "leaning-in-almost": {"text": "Faces angled toward one another and stopped just short of touching, both still.",
            "min_cast": 2},
        "seated-legs-across": {"text": "B sits with her legs draped across A's lap, A resting a hand on B's knee.",
            "min_cast": 2},
        "neck-glance-behind": {"text": "A stands behind and lowers her face toward B's neck while B looks straight into the camera.",
            "min_cast": 2},
        "wrapped-from-behind": {"text": "A wraps both arms fully around B from behind, chins nearly level, both facing the lens.",
            "min_cast": 2},
        "hands-clasped-high": {"text": "Standing face to face with hands clasped and raised between their chests, foreheads close.",
            "min_cast": 2},
        "one-pulling-closer": {"text": "A takes B by the waist and draws her in a step, B's hand landing on A's shoulder.",
            "min_cast": 2},
        "shared-mirror-look": {"text": "The two stand pressed together before a mirror, each watching the other's reflection.",
            "min_cast": 2},
        "lying-one-over-other": {"text": "B lies back and A leans over her on one straight arm, both looking at the camera.",
            "min_cast": 2},
        "hair-brushed-aside": {"text": "A sweeps B's hair back from her face with one hand, B's eyes closing.",
            "min_cast": 2},
        "hip-to-hip-standing": {"text": "Standing hip to hip with outside hands on their own waists and heads tipped together.",
            "min_cast": 2},
        "seated-close-knees-touch": {"text": "Seated facing one another with knees interlocked, leaning in with forearms on their own thighs.",
            "min_cast": 2},
        "chin-lift-between": {"text": "A lifts B's chin with two fingers, B's gaze travelling up to meet hers.",
            "min_cast": 2},
        "arm-around-waist-walk": {"text": "The two walk slowly side by side with A's arm low around B's waist, both glancing back.",
            "min_cast": 2},
        "reclined-pair-tangle": {"text": "Both recline together with legs loosely tangled and one arm each behind their heads.",
            "min_cast": 2},
        "shoulder-lean-eyes-shut": {"text": "B rests her head on A's shoulder with her eyes shut while A looks toward the lens.",
            "min_cast": 2},
        "hands-on-each-face": {"text": "Each holds the other's face in both hands, foreheads touching, eyes closed.",
            "min_cast": 2},
        "back-arch-into": {"text": "B arches backward into A's supporting arm while A leans over her, both in profile.",
            "min_cast": 2},
        "close-dance-hold": {"text": "Held in a slow close dance position, bodies touching from chest to hip, faces turned to the camera.",
            "min_cast": 2},
        "one-kneeling-looking-up": {"text": "A kneels before B and looks up at her, B's hand resting in A's hair.",
            "min_cast": 2},
        "shared-glance-down": {"text": "Standing very close, both looking down at the small space between them.",
            "min_cast": 2},
        "wrist-hold-close": {"text": "A holds B's wrist between them at chest height, the two standing almost touching.",
            "min_cast": 2},
        "seated-behind-embrace": {"text": "A sits behind B on the floor with legs either side, arms wrapped around B's middle.",
            "min_cast": 2},
        "cheek-turn-away": {"text": "A leans in close while B turns her cheek away, still smiling, eyes on the lens.",
            "min_cast": 2},
        "lying-head-on-stomach": {"text": "B lies with her head resting on A's stomach, both looking up toward the camera.",
            "min_cast": 2},
        "shoulder-bare-touch": {"text": "A rests her fingertips on B's bare shoulder, both watching the point of contact.",
            "min_cast": 2},
        "leaning-wall-pair": {"text": "A leans one forearm on the wall above B, who is backed against it looking up.",
            "min_cast": 2},
        "eyes-closed-both-close": {"text": "Standing very close with both sets of eyes closed and faces angled toward one another.",
            "min_cast": 2},
        "hand-slide-hip": {"text": "A's hand rests at the curve of B's hip as they stand side on, both facing the lens.",
            "min_cast": 2},
        "kneel-behind-lean-back": {"text": "B kneels and leans back against A who kneels behind her, A's hands on B's shoulders.",
            "min_cast": 2},
        "close-profile-pair": {"text": "The two stand in tight profile facing each other, noses almost level, neither looking away.",
            "min_cast": 2},
        "arm-draped-shoulders-close": {"text": "A drapes one arm heavily over B's shoulders and pulls her in until their hips meet.",
            "min_cast": 2},
        "lying-side-by-side-look": {"text": "Lying side by side on their backs with heads turned toward each other.",
            "min_cast": 2},
        "waist-hold-back-bend": {"text": "A holds B at the waist while B bends backward away from her, one arm falling loose.",
            "min_cast": 2},
        "shared-breath-pause": {"text": "Stopped mid-motion a breath apart, both perfectly still, eyes on each other.",
            "min_cast": 2},
        "one-behind-chin-shoulder": {"text": "A stands behind B and rests her chin on B's shoulder, both faces toward the camera.",
            "min_cast": 2},
    },
    "Erotic": {
        "entwined-lying": {"text": "A and B lie facing one another with legs loosely entwined and a sheet drawn over both.",
            "min_cast": 2},
        "embrace-full-length": {"text": "The two stand pressed together full length, arms around each other, faces turned to the same side.",
            "min_cast": 2},
        "back-to-chest-sheet": {"text": "B leans back against A's chest with a shared sheet across them both, A's arms around her middle.",
            "min_cast": 2},
        "foreheads-eyes-closed": {"text": "Kneeling face to face with foreheads resting together and both sets of eyes closed.",
            "min_cast": 2},
        "one-lying-one-over": {"text": "B lies on her back and A leans over her on both forearms, their faces very close.",
            "min_cast": 2},
        "tangled-legs-sheet": {"text": "Both on their backs with legs tangled together beneath a shared sheet, heads turned toward each other.",
            "min_cast": 2},
        "arms-around-waist-close": {"text": "Standing chest to chest with each holding the other's waist, hips touching.",
            "min_cast": 2},
        "spooned-side-lying": {"text": "Lying on their sides one behind the other, A's arm draped over B's waist.",
            "min_cast": 2},
        "shoulder-kiss-behind": {"text": "A stands behind B and lowers her face to B's bare shoulder, B's head tipped away.",
            "min_cast": 2},
        "seated-facing-close": {"text": "Seated facing one another with legs interlocked and both leaning in, hands on each other's hips.",
            "min_cast": 2},
        "hair-curtain-shared": {"text": "Leaning in close enough that their hair falls together and hides the space between their faces.",
            "min_cast": 2},
        "one-kneeling-embrace": {"text": "A kneels and wraps both arms around B's waist, B's hands resting in A's hair.",
            "min_cast": 2},
        "backs-pressed-standing": {"text": "Standing back to back with bare shoulders pressed, both heads tipped back until they touch.",
            "min_cast": 2},
        "lying-head-on-chest": {"text": "B lies with her head resting on A's chest, A's hand at the back of her head.",
            "min_cast": 2},
        "profile-pair-close": {"text": "Both in tight profile facing each other, noses almost touching, neither moving.",
            "min_cast": 2},
        "shared-sheet-standing": {"text": "Standing wrapped together inside a single sheet, only their shoulders and faces clear of it.",
            "min_cast": 2},
        "arm-across-both-chests": {"text": "A stands behind and lays one arm across B's collarbones, drawing her back against her.",
            "min_cast": 2},
        "seated-lap-facing": {"text": "B sits facing A across her lap with both arms looped behind A's neck.",
            "min_cast": 2},
        "hands-on-each-waist-lean": {"text": "Facing one another, each with both hands at the other's waist, leaning back from the hips.",
            "min_cast": 2},
        "cheek-to-shoulder-rest": {"text": "B rests her cheek against A's bare shoulder with her eyes closed, A looking down at her.",
            "min_cast": 2},
        "lying-face-to-face-close": {"text": "Lying on their sides face to face with knees touching and one hand on the other's hip.",
            "min_cast": 2},
        "one-behind-hands-stomach": {"text": "A stands close behind B with both hands flat on B's stomach, B leaning back into her.",
            "min_cast": 2},
        "kneel-pair-embrace": {"text": "Both kneeling and folded into a close embrace, faces turned into each other's necks.",
            "min_cast": 2},
        "leg-hooked-over": {"text": "Lying together with B's top leg hooked over A's hip, both facing one another.",
            "min_cast": 2},
        "shoulder-blades-touch": {"text": "Seated back to back on the floor with bare shoulder blades pressed and heads tipped apart.",
            "min_cast": 2},
        "arms-raised-together": {"text": "Standing chest to chest with all four arms raised and hands clasped above their heads.",
            "min_cast": 2},
        "one-lifting-other-close": {"text": "A lifts B slightly against her body, B's arms around A's neck and legs relaxed.",
            "min_cast": 2},
        "close-dance-bare-shoulders": {"text": "Held in a slow close dance with bare shoulders touching and faces a breath apart.",
            "min_cast": 2},
        "sheet-between-bodies": {"text": "Standing with a sheer sheet caught between their bodies, both hands pressed to it.",
            "min_cast": 2},
        "lying-arms-overhead-pair": {"text": "Both lying on their backs side by side with arms stretched overhead, hands overlapping.",
            "min_cast": 2},
        "chin-on-shoulder-behind": {"text": "A rests her chin on B's bare shoulder from behind, both looking toward the camera.",
            "min_cast": 2},
        "seated-legs-over-lap": {"text": "B sits with her legs draped across A's lap and leans back onto her elbows.",
            "min_cast": 2},
        "hands-on-each-face-close": {"text": "Each holds the other's face in both hands with foreheads touching and eyes shut.",
            "min_cast": 2},
        "one-arched-into-other": {"text": "B arches backward into A, who supports her at the waist and leans over the arch.",
            "min_cast": 2},
        "curled-together-side": {"text": "Curled together on one side, B tucked inside the curve of A's body, both still.",
            "min_cast": 2},
        "shoulder-to-shoulder-bare": {"text": "Sitting shoulder to shoulder with bare arms touching, both looking straight ahead.",
            "min_cast": 2},
        "reaching-around-behind": {"text": "A reaches around B from behind with both hands meeting at B's front, cheeks touching.",
            "min_cast": 2},
        "lying-crosswise-pair": {"text": "One lies across the other at the waist, both relaxed, heads at opposite edges of the frame.",
            "min_cast": 2},
        "close-standing-still": {"text": "Standing bare-shouldered a hand's width apart, perfectly still, holding each other's eyes.",
            "min_cast": 2},
        "one-over-shoulder-look": {"text": "A wraps B from behind while B looks back over her own shoulder at A.",
            "min_cast": 2},
        "knees-drawn-together": {"text": "Seated close with both pairs of knees drawn up and touching, arms around their own shins.",
            "min_cast": 2},
        "sheet-pulled-between": {"text": "Each holding an end of the same sheet and drawing it taut between their bodies.",
            "min_cast": 2},
        "lying-hands-clasped": {"text": "Lying side by side on their backs with hands clasped in the space between them.",
            "min_cast": 2},
        "leaning-into-neck": {"text": "A leans in toward B's neck without touching it, B's chin lifting away.",
            "min_cast": 2},
        "hip-to-hip-bare": {"text": "Standing hip to hip with bare shoulders and outside arms hanging loose, heads tipped together.",
            "min_cast": 2},
        "seated-behind-wrapped": {"text": "A sits behind B with legs either side and both arms wrapped around her middle.",
            "min_cast": 2},
        "faces-turned-together": {"text": "Both lying on their fronts with faces turned toward one another on folded arms.",
            "min_cast": 2},
        "standing-forehead-rest": {"text": "Standing close with A's forehead resting against B's temple, both looking down.",
            "min_cast": 2},
        "close-pair-shadowed": {"text": "Standing wrapped together in low light so the two bodies read as one shadowed mass.",
            "min_cast": 2},
        "waking-pair-tangle": {"text": "Half tangled in bedding together, one arm thrown across the other, both just waking.",
            "min_cast": 2},
    },
}
