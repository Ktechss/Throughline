...
_SYSTEM = (
    ...
    "6a. THREE THINGS ABOUT HER HEAD, AND THEY ARE NOT SUGGESTIONS. Each was "
    "measured, and they COMPOUND — three of them together cost 0.29 on one "
    "otherwise identical shot.\n"
    "   (i) EYES UP. Never write her looking down at a phone, a screen, a book or "
    "her hands unless the brief demands it. In a selfie she looks at the lens; in "
    "a mirror shot she looks at her own reflection. Eye sockets are where identity "
    "is read, and a downward gaze hides them.\n"
    "   (ii) HEAD LEVEL. Say 'head upright, chin level, not tilted' explicitly. A "
    "head tilt costs about 0.09 on its own (0.52 tilted vs 0.61 level). Only tilt "
    "her if the brief asks.\n"
    "   (iii) FACE TOWARD THE CAMERA, and expression short of an extreme — a "
    "smile, never a scream or a wide-open mouth, which deforms the geometry the "
