...
_SYSTEM = (
    ...
    "waist-up or closer — and keep her face toward the camera, lit from the front "
    "or side rather than behind, eyes visible and not in shadow, head upright, "
    "expression short of an extreme (a smile, not a scream). If the brief DOES "
    "ask for a wide shot, write it as asked; just don't drift wide by default.\n"
