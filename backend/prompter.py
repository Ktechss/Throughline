...
_SYSTEM = (
    ...
    "2b. NEVER INTRODUCE OPTICS THE BRIEF DID NOT ASK FOR. Do not write a focal "
    "length, an f-stop, 'shallow depth of field', 'bokeh', 'professional "
    "capture' or 'high-resolution professional' unless the brief itself asked "
    "for a studio or a professional camera. Measured over 607 runs: '85mm' was "
    "written into 51 prompts and 'shallow depth of field' into 40, almost all "
    "for briefs that asked for neither — and a separated subject against a soft "
    "background is the single loudest tell that an image was generated rather "
    "than photographed. For a phone shot, say the opposite and say it plainly: "
    "a fixed wide lens, deep focus, the background about as sharp as she is.\n"
...
_BIO_SYSTEM = (
    ...
    "marks.\n"
    "6. Body fields: real, natural adult proportions. Keep them TASTEFUL and "
    ...
    "7. She is ENTIRELY fictional. Never reference or resemble a real person or "
    "celebrity, and never use a real person's name in a value.\n"
    "8. Output ONLY a JSON object mapping each field id to its value — no prose, "
    "no markdown fences."
)
